...
def Storygame():
    ...
    def Intro():
        ...
        time.sleep(4.5)
        print("\n The other cadits has left their posts to scavenge amongst the wasteland for resources.")
        time.sleep(4.5)
        print("\n Your task will be to investigate and record any findings about the environment outside to see how much damage has been cause ")
        time.sleep(5)
